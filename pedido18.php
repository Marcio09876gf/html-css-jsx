...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Corretor Imobiliário</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Corretor Imobiliário">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Casa unifamiliar" required> 
           <label for="tipodeservico">Casa unifamiliar</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Casa germinada" required>
         <label for="tipodeservico">BalCasa germinada</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Terreno" required>
         <label for="tipodeservico">Terreno</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Local comercial" required>
         <label for="tipodeservico">Local comercial</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Apartamento" required>
         <label for="tipodeservico">Apartamento</label>
          </imput>
          <br>
          
          
          <h2>Sabe se há irregularidade no imóvel?</h2>
          ...
          <input type="radio" id="precisadematerial" name="precisadematerial" value="Não" required>
           ...
           <br><br>
           <h2>Tamanho do imóvel</h2>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="Até 50m2" required>
             <label for="aondeeoservico">Até 50m2</label>
           </imput>
           <br>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="De 51m2 a 75m2" required>
             <label for="aondeeoservico">De 50m2 a 75m2</label>
           </imput>
           <br>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="De 76m2 a 100m2" required>
             <label for="aondeeoservico">De 101m2 a 150m2</label>
           </imput>
           <br>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="De 151m2 a 200m2" required>
             <label for="aondeeoservico">De 151m2 a 200m2</label>
           </imput>
           <br>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="Mais de 200m2" required>
             <label for="aondeeoservico">Mais de 200m2</label>
           </imput>
            <br><br>
