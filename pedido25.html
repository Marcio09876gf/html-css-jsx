...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Barbeiro a Domicílio</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Barbeiro a Domicílio">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Não é para evento especial" required>
           <label for="tipodeservico">Não é para evento especial</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Casamento" required>
         <label for="tipodeservico">Casamento</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Festa privada" required>
         <label for="tipodeservico">Festa privada</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Sessão de fotos particular" required>
         <label for="tipodeservico">Sessão de fotos particular</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Evento corporativo" required>
         <label for="tipodeservico">Evento corporativo</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Despedida de solteiro" required>
         <label for="tipodeservico">Despedida de solteiro</label>
          </imput>
          <br>
