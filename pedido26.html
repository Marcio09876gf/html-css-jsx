...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Cuidador(a) de idosos</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Cuidador(a) de idosos">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Pessoa idosa" required>
           <label for="tipodeservico">Pessoa idosa</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Idosa dependente" required>
         <label for="tipodeservico">Idosa dependente</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Pessoa enferma" required>
         <label for="tipodeservico">Pessoa enferma</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Pessoa hospitalizada" required>
         <label for="tipodeservico">Pessoa hospitalizada</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Pessoa deficiente" required>
         <label for="tipodeservico">Pessoa deficiente</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Outros</label>
          ...
          <input type="radio" id="precisadematerial" name="precisadematerial" value="1" required>
            <label for="precisadematerial">1</label>
          </imput>
          <br>
          <input type="radio" id="precisadematerial" name="precisadematerial" value="2" required>
            <label for="precisadematerial">2</label>
          </imput>
           <br>
           <input type="radio" id="tipodeservico" name="tipodeservico" value="3" required>
         <label for="tipodeservico">3</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="4" required>
         <label for="tipodeservico">4</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Mais de 4" required>
         <label for="tipodeservico">Mais de 4</label>
          </imput>
          <br>
           <br>
           <h2>Aonde é o serviço</h2>
           <input type="radio" id="aondeeoservico" name="aondeeoservico">
           ...
           <br>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="Casa de repouso" required>
             <label for="aondeeoservico">Casa de repouso</label>
           </imput>
           <br>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="Hospitalizada" required>
             <label for="aondeeoservico">Hospitalizada</label>
           </imput>
            <br><br>
