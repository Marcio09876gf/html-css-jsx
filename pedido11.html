...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Serralheiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Serralheiro">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Janela/porta" required>
           <label for="tipodeservico">Janela/porta</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Corrimão/escada" required>
         <label for="tipodeservico">Coorrimão/escada</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Esquadra" required>
         <label for="tipodeservico">Esquadra</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Textura/granito</label>
          ...
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Mezanino/sacada" required>
         <label for="tipodeservico">Mezanino/sacada</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Portão" required>
         <label for="tipodeservico">Portão</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Móveis" required>
         <label for="tipodeservico">Móveis</label>
          </imput>
          <br>
