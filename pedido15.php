...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Chaveiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Chaveiro">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Abrir Fechadura" required> 
           <label for="tipodeservico">Abrir Fechadura</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Cópia da chave" required>
         <label for="tipodeservico">Cópia da chave</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Abrir porta de carro" required>
         <label for="tipodeservico">Abrir porta de carro</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Instalar/trocar fechadura</label>
          ...
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Codificação de chaves/de cilindro" required>
         <label for="tipodeservico">Codificação de chaves/de cilindro</label>
          </imput>
          <br>
