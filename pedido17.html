...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Mecanico de Autos</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Mecanico de Autos">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Alinhamento" required> 
           <label for="tipodeservico">Alinhamento</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Balanceamento" required>
         <label for="tipodeservico">Balanceamento</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Cambagem" required>
         <label for="tipodeservico">Cambagem</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Direção hidráulica" required>
         <label for="tipodeservico">Direção hidráulica</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Freios e suspensão" required>
         <label for="tipodeservico">Freios e suspensão</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Injeção eletronica" required>
         <label for="tipodeservico">Injeção eletronica</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Revisão geral" required>
         <label for="tipodeservico">Revisão geral</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Troca de óleo do motor" required>
         <label for="tipodeservico">Troca de óleo do motor</label>
          </imput>
          <br>
