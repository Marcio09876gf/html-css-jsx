...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Marceneiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Marceneiro">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Portas/janelas" required>
           <label for="tipodeservico">Portas/janelas</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Móveis sob medida" required>
         <label for="tipodeservico">Móveis sob medida</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Reformas" required>
         <label for="tipodeservico">Reformas</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Escadas</label>
          ...
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar" required>
         <label for="tipodeservico">Instalar</label>
          </imput>
          <br>
