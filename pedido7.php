...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Telhados</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Telhados">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar telhas" required>
           <label for="tipodeservico">Instalar telhas</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar calha" required>
         <label for="tipodeservico">Instalar calha</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar claribóia" required>
         <label for="tipodeservico">Instalar claribóia</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Instalar ar condicionado</label>
          ...
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Reformar" required>
         <label for="tipodeservico">Reformar</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Retelhar" required>
         <label for="tipodeservico">Retelhar</label>
          </imput>
          <br>
