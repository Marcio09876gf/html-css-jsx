...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Ar Condicionado</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Ar Condicionado">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Manutenção de ar condicionado" required> 
           <label for="tipodeservico">Manutenção de ar condicionado</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar ar condicionado" required>
         <label for="tipodeservico">Instalar ar condicionado</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar ar central" required>
         <label for="tipodeservico">Instalar ar central</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar/trocar fechadura" required>
         <label for="tipodeservico">Instalar/trocar fechadura</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Reparar ar condicionado" required>
         <label for="tipodeservico">Reparar ar condicionado</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Fornecer ar condicionado" required>
         <label for="tipodeservico">Fornecer ar condicionado</label>
          </imput>
          <br>
