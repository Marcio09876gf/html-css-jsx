...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Elétrica</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Elétrica">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Manutenção/instalação" required>
           <label for="tipodeservico">Manutenção/instalação</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalação de ventilador de teto" required>
         <label for="tipodeservico">Instalação de ventilador de teto</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Chuveiro elétrico" required>
         <label for="tipodeservico">Chuveiro elétrico</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Instalar ar condicionado</label>
          ...
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Dsjuntor/quadro de luz" required>
         <label for="tipodeservico">Dsjuntor/quadro de luz</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Tomadas" required>
         <label for="tipodeservico">Tomadas</label>
          </imput>
          <br>
