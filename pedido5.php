...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Dry Wall</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Dry Wall">
         ...
         <label for="tipodeservico">Manutenção</label>
          ...
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Fazer móveis" required>
         <label for="tipodeservico">Fazer móveis</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Divisórias" required>
         <label for="tipodeservico">Divisórias</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar" required>
         <label for="tipodeservico">Instalar</label>
