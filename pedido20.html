...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Vidraceiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">v
          <input type="hidden" id="servico" name="servico" value="Vidraceiro">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Conserto" required>
           <label for="tipodeservico">Conserto</label>
         </imput>
         <br>
         ...
         <label for="tipodeservico">instalação</label>
          ...
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Aplicação de película" required>
         <label for="tipodeservico">Aplicação de película</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Fabricação" required>
         <label for="tipodeservico">Fabricação</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Corte" required>
         <label for="tipodeservico">Corte</label>
          </imput>
          <br>
