...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Marido de Aluguel</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Marido de Aluguel">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Suporte de tv" required>
           <label for="tipodeservico">Suporte de tv</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Prateleiras" required>
         <label for="tipodeservico">Prateleiras</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Varal" required>
         <label for="tipodeservico">Varal</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Quadro" required>
         <label for="tipodeservico">Quadro</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Cortinas" required>
         <label for="tipodeservico">Cortinas</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Varal" required>
         <label for="tipodeservico">Varal</label>
          ...
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Persianas" required>
         <label for="tipodeservico">Persianas</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Vaso sanitário" required>
         <label for="tipodeservico">Vaso sanitário</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Itens de banheiros" required>
         <label for="tipodeservico">Itens de banheiros</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Montagens de móveis" required>
         <label for="tipodeservico">Montagens de móveis</label>
          </imput>
          <br>
