...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Pedreiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Pedreiro">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Pisos/azulejos" required>
           <label for="tipodeservico">Pisos/azulejos</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Reboco" required>
         <label for="tipodeservico">Reboco</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Alvenaria" required>
         <label for="tipodeservico">Alvenaria</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Escadas" required>
         <label for="tipodeservico">Escadas</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Contrapiso" required>
         <label for="tipodeservico">Contrapiso</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Churrasqueira" required>
         <label for="tipodeservico">Churrasqueira</label>
          </imput>
          <br>
