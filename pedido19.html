...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Protese Dentária</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Protese Dentária">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Avaliação" required> 
           <label for="tipodeservico">Avaliação</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Próteses fixas" required>
         <label for="tipodeservico">Próteses fixas</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Próteses móveis" required>
         <label for="tipodeservico">Próteses móveis</label>
          </imput>
          <br>
          ...
          <input type="radio" id="precisadematerial" name="precisadematerial" value="Não" required>
           ...
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="Galpão" required>
            ...
            <br>
             ...
             <br>
             <input type="radio" id="horariodoservico" name="horariodoservico" value="Tarde(12hs às 118hs)" required>
