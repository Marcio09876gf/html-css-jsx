...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Gesseiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Gesseiro">
         ...
         <label for="tipodeservico">Instalação</label>
          ...
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Decoração" required>
         <label for="tipodeservico">Decoração</label>
          </imput>
          <br>
