...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Dedetizador</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Dedetizador">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Dedetização" required>
           <label for="tipodeservico">Dedetização</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Descupinização" required>
         <label for="tipodeservico">Descupinização</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Desinsetinização" required>
         <label for="tipodeservico">Desinsetinização</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Controle de pragas" required>
         <label for="tipodeservico">Controle de pragas</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Desratinização" required>
         <label for="tipodeservico">Desratinização</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Eliminar mosquito" required>
         <label for="tipodeservico">Eliminar mosquito</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Eliminar carrapatos" required>
         <label for="tipodeservico">Eliminar carrapatos</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Eliminar pulgas" required>
         <label for="tipodeservico">Eliminar pulgas</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpeza de caixas d'águas" required>
         <label for="tipodeservico">Limpeza de caixas d'águas</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Impermeabilização de caixas d'águas" required>
         <label for="tipodeservico">Impermeabilização de caixas d'águas</label>
          </imput>
          <br>
  ...
  <script src="
https://cdn.jsdelivr.net/npm/cleave.js@1.6.0/dist/cleave.min.js"></script>
<script>
