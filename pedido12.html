...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Jardineiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Jardineiro">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Poda de árvores" required>
           <label for="tipodeservico">Poda de árvores</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpar jardim" required>
         <label for="tipodeservico">Limpar jardim</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Fazer jardim" required>
         <label for="tipodeservico">Fazer jardim</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Plantar gramado" required>
         <label for="tipodeservico">Plantar gramado</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Fazer jardim" required>
         <label for="tipodeservico">Fazer jardim</label>
