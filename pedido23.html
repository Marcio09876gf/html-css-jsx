...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Ventilador</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Ventilador">
         ...
         <label for="tipodeservico">Instalação</label>
          ...
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Consertar de teto" required>
         <label for="tipodeservico">Consertar de teto</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalar de teto" required>
         <label for="tipodeservico">Instalar de teto</label>
          </imput>
          <br>
