...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Montador de Móveis</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Montador de Móveis">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Montagem" required> 
           <label for="tipodeservico">Montagem</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Desmontagem" required>
         <label for="tipodeservico">Desmontagem</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Móveis moldulados" required>
         <label for="tipodeservico">Móveis moldulados</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Móveis planejados" required>
         <label for="tipodeservico">Móveis planejados</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Móveis de aço" required>
         <label for="tipodeservico">Móveis de aço</label>
          </imput>
          <br>
