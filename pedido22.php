...
<body>
  <div class="box">  
    <form action="http://www.sistema.oiindicai.com.br/sistema/privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Diarista</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Diarista">
           > <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Pós-obra" required>
           <label for="tipodeservico">Pós-obra</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Padrão" required>
         <label for="tipodeservico">Padrão</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpeza de vidros" required>
         <label for="tipodeservico">Limpeza de vidros</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Comercial" required>
         <label for="tipodeservico">Comercial</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Pesada" required>
         <label for="tipodeservico">Pesada</label>
          </imput>
          <br>
          
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpeza pós ou pré mudança" required>
         <label for="tipodeservico">Limpeza pós ou pré mudança</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Diarista" required>
         <label for="tipodeservico">Diarista</label>
          </imput>
          <br>
          ...
          <input type="radio" id="precisadematerial" name="precisadematerial" value="Não" required>
           ...
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="Galpão" required>
            ...
            <br>
           <input type="radio" id="aondeeoservico" name="aondeeoservico" value="Casa" required>
             <label for="aondeeoservico">Escritório</label>
           </imput>
           <br>
            ...
            <br>
            <input type="radio" id="quandoseraoservico" name="quandoseraoservico" value="Essa semana" required>
              <label for="quandoseraoservico">Essa semana</label>
            </imput>
            <br>
            <input type="radio" id="quandoseraoservico" name="quandoseraoservico" value="Em 7_dias" required>
              <label for="quandoseraoservico">Em 7 dias</label>
            </imput>
            <br>
            <input type="radio" id="quandoseraoservico" name="quandoseraoservico" value="Em 30 dias" required>
              <label for="quandoseraoservico">Em 30 dias</label>
            </imput>
            <br>
            <input type="radio" id="quandoseraoservico" name="quandoseraoservico" value="Sou flexível" required>
