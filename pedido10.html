...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Piscineiro</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Piscineiro">
         ...
         <label for="tipodeservico">Massa corridda</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Textura/granito</label>
          ...
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpeza" required>
         <label for="tipodeservico">Limpeza</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Equipamentos" required>
         <label for="tipodeservico">Equipamentos</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Reparação" required>
         <label for="tipodeservico">Reparação</label>
          </imput>
          <br>
