...
<body>
  <div class="box">
   ...
   <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Encanador</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Encanador">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Manutenção" required>
           <label for="tipodeservico">Manutenção</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Instalação" required>
         <label for="tipodeservico">Instalação</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Pia" required>
         <label for="tipodeservico">Pia</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Chuveiro" required>
         <label for="tipodeservico">Chuveiro</label>
          </imput>
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Descarga" required>
         <label for="tipodeservico">Descarga</label>
          </imput>
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Caça vazamento" required>
         <label for="tipodeservico">Caça vazamento</label>
          </imput>
          <br>
