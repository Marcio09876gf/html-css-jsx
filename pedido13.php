...
<body>
  <div class="box">  
    <form action="privado/pedidosql.php" method="POST">
      <fieldset>
        <legend><h2>Pedido de Limpeza de imóveis</h2></legend>
          <br>
          <input type="hidden" id="valy" name="valy" value="75">
          <input type="hidden" id="servico" name="servico" value="Limpeza de imóveis">
            <h2>Tipo de serviço</h2> 
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpar tanques" required>
           <label for="tipodeservico">Limpar tanques</label>
         </imput>
         <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpar reservatórios" required>
         <label for="tipodeservico">Limpar reservatórios</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Diarista</label>
          ...
          <br>
         <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpeza pós obra" required>
         <label for="tipodeservico">Limpeza pós obra</label>
          </imput>
          <br>
         ...
         <label for="tipodeservico">Limpeza pós ou pré mudança</label>
          ...
          <br>
          <input type="radio" id="tipodeservico" name="tipodeservico" value="Limpeza e desinfectar" required>
         <label for="tipodeservico">Limpeza e desinfectar</label>
          </imput>
          <br>
